package com.wuhanzihai.rbk.ruibeikang.bluetooth;
...
public class NotificationService extends NotificationListenerService {
    ...
    public static final int SERVICE_RESULT_CALL = 101;
    public static final int SERVICE_RESULT_MSG = 102;
    ...
    public static void openNotificationAccess(Activity context) {
        try {
