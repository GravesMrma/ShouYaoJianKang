...
import com.wuhanzihai.rbk.ruibeikang.data.entity.HealthFoodBean
import com.wuhanzihai.rbk.ruibeikang.data.entity.HealthTitleBean
import com.wuhanzihai.rbk.ruibeikang.data.protocal.IdReq
...
import kotlinx.android.synthetic.main.activity_health_food.*
import org.jetbrains.anko.act
import java.util.*

class HealthFoodActivity : BaseMvpActivity<HealthInfoPresenter>(), HealthInfoView {
    ...
    override fun onHealthFoodResult(result: HealthFoodBean) {
        tvTitle.setTitleText(result.title.cat_name)
        ...
        for (i in 0 until list.size) {
            ...
            var bundle = Bundle()
            bundle.putInt("cate_id", list[i].cat_id)
    ...
    private fun initData() {
        mPresenter.healthFoodClass(IdReq(intent.getIntExtra("id",0)))
    }
}
